...
// Opis funkcji interfejsu znajduja sie w pliku nag³ówkowym Shell.h
...
void Shell::display_help() {
	...
	std::cout << magenta << "[SHELL] " << white << "Dostepne komendy:\n\n";
...
int main() {
	...
	Initialize(); // inicjalizuje virtual memory
	...
	std::string program2 = "FC1 ROOT BIG FC1 BIG F1 CF1 F1 P1 CF1 F1 P2 DFC BIG FED1 P1 DFC BIG RST";
